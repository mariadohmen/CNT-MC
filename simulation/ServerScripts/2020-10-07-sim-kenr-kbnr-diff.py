# -*- coding: utf-8 -*-
"""
Created on Wed Oct  7 20:52:56 2020
...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  6 15:28:45 2020
...
constants_array[:, 0] = np.linspace(4e8, 4e9, 10)
constants_array[:, 1] = np.linspace(2e8, 2e7, 10)

for i in np.arange(10):
    sim = CNTSimFile(
            f'../sim_output/2020-10-07-exciton_sim-kenr_kbnr_diff_sever_prist_{i}.h5',
            kin_const_1)
...
for i in np.arange(10):
    sim = CNTSimFile(
            f'../sim_output/2020-10-07-exciton_sim-kenr_kbnr_diff_sever_defect_{i}.h5',
            kin_const_1)
    sim.parameter_dependence(100000, exciton_sim, constants_array, ['k_bnr',
                                                                    'k_enr'],
                             ['k_br', 'k_er', 'k_bnr', 'k_enr', 'k_be', 'k_ed',
