# -*- coding: utf-8 -*-
"""
Created on Thu Oct  8 17:54:17 2020
...
for i in np.arange(10):
    sim = CNTSimFile(
            f'../sim_output/2020-10-08-exciton_sim-kenr_kbnr_diff_sever_prist_{i}.h5',
            kin_const_1)
...
for i in np.arange(10):
    sim = CNTSimFile(
            f'../sim_output/2020-10-08-exciton_sim-kenr_kbnr_diff_sever_defect_{i}.h5',
            kin_const_1)
    sim.parameter_dependence(100000, exciton_sim, constants_array, ['k_bnr',
                                                                    'k_enr'],
                             ['k_br', 'k_er', 'k_bnr', 'k_enr', 'k_be', 'k_ed',
